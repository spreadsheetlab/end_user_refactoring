...
\subsubsection{Findings}
On average, the programs from children had 2.6 smells each and the programs from the community had 3.9 smells each, though we note that the programs from the community tend to be larger (e.g., an average of 101 rules vs. 42 rules). 
...
This smell was present in 61\% of the programs. All instances were that of duplicate \emph{when} clauses within a page, and there were no instances of identical rules on a page or identical pages within the same character. 

\subsection{Summary}
Table~\ref{tab:smellsummary} summarizes the frequencies of occurrence of the various smells in the Kodu and EV3 programs. 
