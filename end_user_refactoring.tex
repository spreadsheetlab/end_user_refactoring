...
Duplicate Code
	...
	& Multiple Array Copies \cite{chambers2013smell}
\\ % Continuation
& 
...
As most OO smells do not have a direct impact on performance, the equivalents of OO smells for LabVIEW have not yet been defined. \emph{Redundant Operations} is an exception, which acts like a no-op, or \emph{Multiple Array Copies}, which identifies redundant storage of the same data, similar to \emph{Duplicate Code}. 
