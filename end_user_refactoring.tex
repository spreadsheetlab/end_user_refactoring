...
Through exploring the commonalities and differences among the domains, we distill catalog of generic end-user smells. We demonstrate the broad applicability of the catalog by applying it to two new end-user languages, both aimed at education: \ms~and Kudo. The results of this application shows that \todo{... most interesting results here}
\end{abstract}
...
\label{sec:smells:oo}
 ...
 Overall, we often observe similarities in the code smells studied. For example, the \emph{Duplicate Code} smell has been studied in both languages. \todo{is this a fair assesment?}
...
\section{Application}
In the above section, we have distilled a catalog of end-user smells from previous work on end-user smells. In order to demonstrate the applicability of our catalog, we apply it to a new domain: \ms~software (EV3 for short). 
