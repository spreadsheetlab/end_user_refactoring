...
\begin{table}[h]
\begin{tabular}{llll}
\begin{tabular}[c]{@{}l@{}}General\\   Purpose programming languages\end{tabular} & LabVIEW/G                                                                                          & Yahoo Pipes & Spreadsheets                                    \\
Long method                                                                       &                                                                                                    &             & Multiple operations                             \\
Many parameters                                                                   &                                                                                                    &             & Multiple references                             \\
High conditional complexity                                                       &                                                                                                    &             & High conditional complexity                     \\
Lasagna code                                                                      &                                                                                                    &             & Long calculation chain                          \\
Code duplication                                                                  &                                                                                                    &             & Duplicated formulas                             \\
                                                                                  &                                                                                                    &             & Named range of multiple separate ranges         \\
Inappropriate class intimacy                                                      &                                                                                                    &             & Inappropriate worksheet intimacy                \\
Method feature envy                                                               &                                                                                                    &             & Formula feature envy                            \\
Middle man class                                                                  &                                                                                                    &             & Middle man worksheet                            \\
Shotgun surgery                                                &                                                                                                    &             & Shotgun surgery            \\
\textbf{}                                                                         & Too many variables                                                                                 &             &                                                 \\
Allocate memory inside loop                                                       & \begin{tabular}[c]{@{}l@{}}Build array inside loop\\     string concatenation in loop\end{tabular} &             &                                                 \\
                                                                                  & Multiple array copies                                                                              &             &                                                 \\
                                                                                  & No wait in a loop                                                                                  &             & \cellcolor[HTML]{333333}                        \\
\cellcolor[HTML]{F8A102}{\color[HTML]{333333} Unconnected GUI element?}           & \cellcolor[HTML]{F8A102}{\color[HTML]{333333} Unconnected front panel elements}                    &             & \cellcolor[HTML]{333333}                        \\
\rowcolor[HTML]{F8A102} 
{\color[HTML]{333333} Redundant operations}                                       & {\color[HTML]{333333} Redundant operations}                                                        &             & Redundant operations                            \\
\rowcolor[HTML]{F8A102} 
