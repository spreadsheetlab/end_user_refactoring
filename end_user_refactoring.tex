...
An example of this is the \emph{Long Method} smells, which translated the \emph{Multiple Operations} smells because formulas with a large number of operations suffer from similar problems as long methods.
