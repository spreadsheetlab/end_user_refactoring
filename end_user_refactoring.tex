...
\emph{Dead code} is more frequently found in EV3 and lazy classes are more common in Kodu. \emph{Feature envy} was also prevalent across both languages, appearing in 18\% and 22\% of the EV3 and Kodu programs, respectively. The \emph{no-op} smell is present in 41\% of the Kodu programs. 
