...
\title{A Catalog of End-User Smells, and an Application to \ms}
...
There are several OO code smells in Table~\ref{fig:ypexample} that could apply to the other domain too, such as \emph{Message Chain}, but prior work on Yahoo! Pipes does not cover it. Here, we discuss the potential of generalizing some of the OO and domain-specific smell definitions to additional domains. 
