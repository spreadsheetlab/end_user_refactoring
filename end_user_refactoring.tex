...
In robotics inspired languages, actions are performed based on sensor values. This is true of EV3 and Kodu. This provides the opportunity to create conflicting outcomes for the same sensor. 
