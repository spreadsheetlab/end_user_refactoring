...
Users can program each character or object (e.g., a kodu, cycle, apple, tree) individually, and the programming defines how to interact with the world. Each object has 12 pages that can be programmed, analogous to methods in an OO language, where the current page defines the current behavior of the object. 
...
\item[No-op] 
\item[Unused Field] 
\item[Use of Deprecated Interfaces] 
\end{description}
